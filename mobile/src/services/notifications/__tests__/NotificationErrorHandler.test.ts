...
describe('NotificationErrorHandler', () => {
  ...
  describe('withRetry', () => {
    ...
    it('should use default config values', async () => {
      ...
      expect(operation).toHaveBeenCalledTimes(
        NOTIFICATION_CONFIG.TOKEN_MAX_RETRIES + 1,
      );
    });
  });
  ...
  describe('handleNotificationError', () => {
    it('should log error with context', () => {
      ...
      expect(logger.error).toHaveBeenCalledWith(
        'Notification error in testContext',
        error,
      );
    });
  ...
  describe('sanitizeErrorForLogging', () => {
    it('should remove tokens from error messages', () => {
      const error = {
        message:
          'Failed with token: abc123def456ghi789jkl012mno345pqr678stu901vwx234yz567890abcdefghijklmnopqrstuvwxyz1234567890',
        stack:
          'Error at line with token abc123def456ghi789jkl012mno345pqr678stu901vwx234yz567890abcdefghijklmnopqrstuvwxyz1234567890',
      };
    ...
    it('should handle null error', () => {
      ...
      expect(
        NotificationErrorHandler.sanitizeErrorForLogging(undefined),
      ).toBeUndefined();
    });
