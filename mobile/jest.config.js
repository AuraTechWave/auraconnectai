module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!(react-native|@react-native|@react-navigation|react-native-screens|react-native-safe-area-context|react-native-gesture-handler|react-native-reanimated|react-native-vector-icons|react-native-paper|react-native-mmkv|react-native-keychain|react-native-toast-message|@react-native-community|react-native-offline|react-native-config|react-native-permissions|react-native-device-info|react-native-splash-screen|react-native-fast-image|lottie-react-native)/)',
  ],
  moduleNameMapper: {
    '^@/(.*)$': '<rootDir>/src/$1',
