...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('active', 'inactive', 'suspended', 'deleted', name='customerstatus', create_type=False), nullable=False),
        sa.Column('tier', sa.Enum('bronze', 'silver', 'gold', 'platinum', 'vip', name='customertier', create_type=False), nullable=False),
