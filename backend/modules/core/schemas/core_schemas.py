...
class RestaurantBase(BaseModel):
    ...
    brand_name: Optional[str] = Field(None, max_length=200, description="Brand/franchise name")
    ...
    address_line2: Optional[str] = Field(None, max_length=255, description="Suite/Apt/Unit")
    city: str = Field(..., min_length=1, max_length=100, description="City")
    state: str = Field(..., min_length=2, max_length=50, description="State/Province")
    postal_code: str = Field(..., min_length=5, max_length=20, description="Postal/ZIP code")
    country: str = Field("US", min_length=2, max_length=2, description="ISO country code")
...
class LocationBase(BaseModel):
    ...
    location_type: LocationType = Field(LocationType.RESTAURANT, description="Type of location")
...
class FloorBase(BaseModel):
    ...
    allows_reservations: bool = Field(True, description="Allow reservations on this floor")
...
class FloorCreate(FloorBase):
    ...
    background_image: Optional[str] = Field(None, max_length=500, description="Background image URL")
...
class FloorUpdate(BaseModel):
    ...
    service_charge_percent: Optional[Decimal] = Field(None, ge=0, le=100, decimal_places=2)
