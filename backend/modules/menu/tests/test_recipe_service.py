...
from ..models.recipe_models import Recipe, RecipeIngredient, RecipeStatus, RecipeComplexity, UnitType
from ..services.recipe_service import RecipeService
from ..schemas.recipe_schemas import (
    RecipeCreate, RecipeUpdate, RecipeIngredientCreate,
    RecipeSearchParams, RecipeCloneRequest
)
...
class TestRecipeService:
    ...
    def test_create_recipe(self, recipe_service, sample_menu_item, sample_inventory_items, db_session):
        ...
        recipe_data = RecipeCreate(
            ...
            instructions=["Season chicken", "Grill for 20 minutes", "Rest for 5 minutes"],
            ingredients=[
        ...
        assert recipe.total_cost == pytest.approx(3.67, rel=0.01)  # 3.50 + 0.16 + 0.0075
        assert recipe.food_cost_percentage == pytest.approx(22.95, rel=0.1)  # 3.67 / 15.99 * 100
    
    def test_create_recipe_duplicate(self, recipe_service, sample_menu_item, sample_inventory_items):
    ...
    def test_update_recipe(self, recipe_service, sample_menu_item, sample_inventory_items):
    ...
    def test_update_recipe_ingredients(self, recipe_service, sample_menu_item, sample_inventory_items):
        ...
        updated_recipe = recipe_service.update_recipe_ingredients(recipe.id, new_ingredients, user_id=1)
        
        assert len(updated_recipe.ingredients) == 2
        assert updated_recipe.total_cost > initial_cost
        assert updated_recipe.version == 2
    
    def test_search_recipes(self, recipe_service, sample_menu_item, sample_inventory_items, db_session):
    ...
    def test_calculate_recipe_cost(self, recipe_service, sample_menu_item, sample_inventory_items):
        ...
        assert cost_analysis.total_ingredient_cost == pytest.approx(7.8, rel=0.01)  # 7.00 + 0.80
    ...
    def test_validate_recipe(self, recipe_service, sample_menu_item, sample_inventory_items):
    ...
    def test_get_compliance_report(self, recipe_service, sample_category, sample_inventory_items, db_session):
    ...
    def test_clone_recipe(self, recipe_service, sample_menu_item, sample_inventory_items, db_session):
    ...
    def test_recipe_history(self, recipe_service, sample_menu_item, sample_inventory_items):
