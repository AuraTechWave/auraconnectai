...
class PerformanceMetrics:
    ...
    def _calculate_endpoint_metrics(self, endpoint: str) -> Dict[str, Any]:
        ...
        cache_hit_rate = (
            (self.cache_hits[endpoint] / total_cache_requests * 100)
        ...
        return {
            ...
            "error_rate": (
                (self.error_counts[endpoint] / self.request_counts[endpoint] * 100)
...
class RecipePerformanceMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app: ASGIApp):
        super().__init__(app)
        self.tracked_prefixes = ["/api/v1/menu/recipes", "/api/v1/menu/recipes/v2"]
