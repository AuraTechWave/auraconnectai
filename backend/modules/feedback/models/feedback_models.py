...
class Review(Base, TimestampMixin):
    ...
    business_responses = relationship(
        "BusinessResponse", back_populates="review", cascade="all, delete-orphan"
    )
...
class Feedback(Base, TimestampMixin):
    ...
    priority = Column(
        ENUM(FeedbackPriority), default=FeedbackPriority.MEDIUM, index=True
    )
    source = Column(ENUM(ReviewSource), default=ReviewSource.WEBSITE, index=True)
    ...
    responses = relationship(
        "FeedbackResponse", back_populates="feedback", cascade="all, delete-orphan"
    )
