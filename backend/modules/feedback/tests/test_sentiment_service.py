...
class TestSentimentAnalysisService:
    ...
    def test_analyze_positive_review(
        self, sentiment_service: SentimentAnalysisService, sample_review
    ):
        ...
        assert (
            "positive" in str(result.raw_data).lower()
            or "keyword" in str(result.raw_data).lower()
        )
    ...
    def test_analyze_neutral_review(
        self, sentiment_service: SentimentAnalysisService, sample_review
    ):
    ...
    def test_analyze_mixed_sentiment_review(
        self, sentiment_service: SentimentAnalysisService, sample_review
    ):
    ...
    def test_analyze_review_with_negation(
        self, sentiment_service: SentimentAnalysisService, sample_review
    ):
    ...
    def test_analyze_review_with_title(
        self, sentiment_service: SentimentAnalysisService, sample_review
    ):
    ...
    def test_analyze_feedback_positive(
        self, sentiment_service: SentimentAnalysisService, sample_feedback
    ):
        """Test analysis of positive feedback"""
        sample_feedback.subject = "Great service!"
        sample_feedback.message = (
            "Your customer service is excellent. Very helpful and professional staff."
        )
    ...
    def test_analyze_feedback_complaint(
        self, sentiment_service: SentimentAnalysisService, sample_feedback
    ):
    ...
    def test_context_adjustments_rating_mismatch(
        self, sentiment_service: SentimentAnalysisService, sample_review
    ):
    ...
    def test_verified_purchase_boost(
        self, sentiment_service: SentimentAnalysisService, sample_review
    ):
    ...
    def test_feedback_type_adjustments(
        self, sentiment_service: SentimentAnalysisService, sample_feedback
    ):
        ...
        context_adjustments = result.raw_data.get("details", {}).get(
            "context_adjustments", []
        )
    ...
    def test_score_to_sentiment_conversion(
        self, sentiment_service: SentimentAnalysisService
    ):
        """Test score to sentiment enum conversion"""
        # Test boundary values
        assert (
            sentiment_service._score_to_sentiment(2.0) == SentimentScore.VERY_POSITIVE
        )
        ...
        assert (
            sentiment_service._score_to_sentiment(-2.0) == SentimentScore.VERY_NEGATIVE
        )
    ...
    def test_force_reanalysis(
        ...
        result = sentiment_service.analyze_review_sentiment(
            sample_review, force_reanalysis=True
        )
    ...
    def test_cached_analysis(
        ...
        result = sentiment_service.analyze_review_sentiment(
            sample_review, force_reanalysis=False
        )
    ...
    async def test_batch_analysis_async(
        ...
        positive_count = sum(
            1
            for r in results
            if r.score in [SentimentScore.POSITIVE, SentimentScore.VERY_POSITIVE]
        )
        negative_count = sum(
            1
            for r in results
            if r.score in [SentimentScore.NEGATIVE, SentimentScore.VERY_NEGATIVE]
        )
    ...
    def test_sentiment_summary_generation(
        self, sentiment_service: SentimentAnalysisService
    ):
        """Test sentiment summary statistics"""
        items = [
            {
                "sentiment_score": SentimentScore.VERY_POSITIVE.value,
                "sentiment_confidence": 0.9,
            },
            {
                "sentiment_score": SentimentScore.POSITIVE.value,
            ...
            {
                "sentiment_score": SentimentScore.NEGATIVE.value,
                "sentiment_confidence": 0.7,
            },
            {
                "sentiment_score": SentimentScore.VERY_NEGATIVE.value,
    ...
    def test_very_long_content(
        ...
        assert isinstance(result, SentimentResult)
        assert (
            result.score == SentimentScore.POSITIVE
        )  # Should detect repeated positive phrase
    ...
    def test_html_and_markup_handling(
        self, sentiment_service: SentimentAnalysisService, sample_review
    ):
    ...
    def test_multiple_languages_basic(
        self, sentiment_service: SentimentAnalysisService, sample_review
    ):
    ...
    def test_sarcasm_detection_basic(
        self, sentiment_service: SentimentAnalysisService, sample_review
    ):
    ...
    def test_intensity_modifiers(
        ...
        sample_review.content = (
            "This product is extremely excellent and incredibly amazing!"
        )
    ...
    def test_combined_analysis_methods(
        self, sentiment_service: SentimentAnalysisService
    ):
    ...
    def test_confidence_calculation(self, sentiment_service: SentimentAnalysisService):
        ...
        high_confidence_text = (
            "excellent amazing outstanding fantastic perfect wonderful brilliant superb"
        )
...
class TestSentimentServiceIntegration:
    ...
    def test_sentiment_keywords_loading(
        self, sentiment_service: SentimentAnalysisService
    ):
    ...
    def test_performance_with_realistic_content(
        self, sentiment_service: SentimentAnalysisService
    ):
