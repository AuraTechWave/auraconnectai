...
class AttendanceLog(Base):
    ...
    method = Column(Enum(CheckInMethod, values_callable=lambda obj: [e.value for e in obj], create_type=False))
    status = Column(Enum(AttendanceStatus, values_callable=lambda obj: [e.value for e in obj], create_type=False))
