...
class TestSchedulingPerformance:
    ...
    def test_conflict_detection_performance_large_dataset(self, scheduling_service, mock_db):
        ...
        for i in range(1000):
            ...
            shift = ScheduledShift(
                ...
                staff_id=staff_id,
                date=shift_date,
                start_time=datetime.combine(shift_date, datetime.min.time()) + timedelta(hours=8),
                end_time=datetime.combine(shift_date, datetime.min.time()) + timedelta(hours=16),
    ...
    def test_auto_schedule_performance_multiple_staff(self, scheduling_service, mock_db):
    ...
    def test_analytics_query_performance(self, scheduling_service, mock_db):
        ...
        for i in range(5000):  # 5000 shifts
            shift = Mock(
                staff_member=Mock(pay_policies=[Mock(hourly_rate=random.uniform(15, 30))]),
        ...
        print(f"Analytics calculation for 5000 shifts took {execution_time:.4f} seconds")
