...
class TestAuthenticationEndpoints:
    ...
    def test_get_current_user_with_valid_token(self, mock_get_user, mock_verify_token, client):
...
class TestPayrollRunEndpoint:
    ...
    @patch('backend.core.auth.verify_token')
    @patch('backend.core.auth.get_user') 
    @patch('backend.modules.staff.services.enhanced_payroll_service.EnhancedPayrollService')
    def test_run_payroll_success(self, mock_service, mock_get_user, mock_verify_token, client):
    ...
    @patch('backend.core.auth.verify_token')
    @patch('backend.core.auth.get_user')
    def test_run_payroll_insufficient_permissions(self, mock_get_user, mock_verify_token, client):
    ...
    @patch('backend.core.auth.verify_token')
    @patch('backend.core.auth.get_user')
    def test_run_payroll_invalid_date_range(self, mock_get_user, mock_verify_token, client):
    ...
    @patch('backend.core.auth.verify_token')
    @patch('backend.core.auth.get_user')
    def test_run_payroll_empty_staff_list(self, mock_get_user, mock_verify_token, client):
...
class TestPayrollRetrievalEndpoints:
    ...
    @patch('backend.core.auth.get_user')
    @patch('backend.modules.staff.services.enhanced_payroll_service.EnhancedPayrollService')
    def test_get_staff_payroll_success(self, mock_service, mock_get_user, mock_verify_token, client):
        ...
        mock_service_instance.get_employee_payment_history = AsyncMock(return_value=[
            {
                'id': 1,
    ...
    @patch('backend.core.auth.get_user')
    @patch('backend.modules.staff.services.enhanced_payroll_service.EnhancedPayrollService')
    def test_get_staff_payroll_detail_success(self, mock_service, mock_get_user, mock_verify_token, client):
        ...
        mock_service_instance.process_payroll_for_staff = AsyncMock(return_value=mock_payroll_response)
...
class TestPayrollStatsEndpoint:
    ...
    @patch('backend.core.auth.get_user')
    @patch('backend.modules.staff.services.enhanced_payroll_service.EnhancedPayrollService')
    def test_get_payroll_stats_success(self, mock_service, mock_get_user, mock_verify_token, client):
        ...
        mock_service_instance = Mock()
        mock_service.return_value = mock_service_instance
        mock_service_instance.get_payroll_summary = AsyncMock(return_value={
            'total_employees': 5,
...
class TestPayrollExportEndpoint:
    ...
    @patch('backend.core.auth.verify_token')  
    @patch('backend.core.auth.get_user')
    def test_export_payroll_invalid_format(self, mock_get_user, mock_verify_token, client):
