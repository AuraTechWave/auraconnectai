...
class TestSchedulePreview:
    ...
    @pytest.mark.asyncio
    async def test_preview_basic(self, async_client: AsyncClient, test_db: AsyncSession, test_user):
    ...
    @pytest.mark.asyncio
    async def test_preview_with_filters(self, async_client: AsyncClient, test_db: AsyncSession, test_user):
    ...
    @pytest.mark.asyncio
    async def test_preview_caching(self, async_client: AsyncClient, test_db: AsyncSession, test_user):
    ...
    @pytest.mark.asyncio
    async def test_preview_cache_invalidation(self, async_client: AsyncClient, test_db: AsyncSession, test_user):
    ...
    @pytest.mark.asyncio
    async def test_paginated_preview(self, async_client: AsyncClient, test_db: AsyncSession, test_user):
    ...
    @pytest.mark.asyncio
    async def test_preview_performance(self, async_client: AsyncClient, test_db: AsyncSession, test_user):
