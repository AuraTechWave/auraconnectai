...
class SchedulingPermissions:
    ...
    PERMISSIONS = {
        "admin": [
            ...
            "approve_swap", "reject_swap", "publish_schedule",
            "generate_schedule", "view_analytics", "manage_all_staff"
        ],
        "manager": [
            "create_template", "update_template",
            "create_shift", "update_shift", "delete_shift",
            "approve_swap", "reject_swap", "publish_schedule",
            "generate_schedule", "view_analytics", "manage_location_staff"
        ],
        "supervisor": [
            "create_shift", "update_shift",
            "approve_swap", "view_analytics", "manage_team_staff"
        ],
        "staff": [
            "view_own_schedule", "request_swap", "update_availability",
            "view_own_analytics"
        ]
    }
    ...
    def can_manage_staff(
        ...
        target_staff = db.query(StaffMember).filter(
            StaffMember.id == target_staff_id
        ).first()
