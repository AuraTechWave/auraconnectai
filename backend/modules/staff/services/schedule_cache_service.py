...
class ScheduleCacheService:
    ...
    async def get_preview_cache(
        ...
        try:
            ...
            key = self._generate_preview_key(restaurant_id, start_date, end_date, filters)
    ...
    async def invalidate_restaurant_cache(self, restaurant_id: int):
        ...
        try:
            ...
            if cache_keys:
                ...
                logger.info(f"Invalidated {len(cache_keys)} cache entries for restaurant {restaurant_id}")
    ...
    async def warm_cache_for_week(
        ...
        try:
            ...
            for day in range(7):
                ...
                existing = await self.get_preview_cache(
            ...
            logger.info(f"Warmed cache for restaurant {restaurant_id}, week of {week_start}")
