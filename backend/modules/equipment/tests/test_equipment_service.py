...
class TestEquipmentService:
    ...
    @pytest.fixture
    def created_equipment(
        self, service: EquipmentService, sample_equipment_data: EquipmentCreate
    ):
    ...
    def test_create_equipment_duplicate_serial(
        self, service: EquipmentService, created_equipment: Equipment
    ):
    ...
    def test_complete_already_completed_maintenance(
        ...
        completion_data = MaintenanceRecordComplete(
            date_performed=datetime.now(), performed_by="John Technician"
        )
    ...
    def test_delete_completed_maintenance_fails(
        self, service: EquipmentService, created_equipment: Equipment
    ):
    ...
    def test_check_overdue_maintenance(
        self, service: EquipmentService, db_session: Session
    ):
