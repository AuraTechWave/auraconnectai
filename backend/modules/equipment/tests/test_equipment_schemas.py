...
class TestEquipmentSchemas:
    ...
    def test_equipment_create_missing_required(self):
        ...
        data = {"equipment_type": "Test Type"}  # Missing equipment_name
    ...
    def test_equipment_create_empty_name(self):
        ...
        data = {"equipment_name": "", "equipment_type": "Test Type"}  # Empty string
    ...
    def test_equipment_update_partial(self):
        ...
        data = {"location": "New Location", "status": EquipmentStatus.NEEDS_MAINTENANCE}
