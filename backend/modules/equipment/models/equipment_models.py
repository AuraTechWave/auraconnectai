...
from sqlalchemy import Column, Integer, String, DateTime, Float, Boolean, Text, Enum as SQLEnum, ForeignKey, Index
...
class MaintenanceRecord(Base):
    ...
    # Maintenance details
    maintenance_type = Column(SQLEnum(MaintenanceType), default=MaintenanceType.PREVENTIVE, nullable=False)
