...
class BulkScheduleMaintenanceResponse(BaseModel):
    ...
    records: List[MaintenanceRecord] = Field(..., description="Created maintenance records")
...
class BulkOperationResponse(BaseModel):
    ...
    errors: Optional[List[BulkOperationError]] = Field(None, description="List of errors")
    processed_ids: List[int] = Field(..., description="IDs that were successfully processed")
