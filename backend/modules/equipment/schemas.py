...
class EquipmentBase(BaseModel):
    ...
    equipment_name: str = Field(..., min_length=1, max_length=200, description="Name of the equipment")
    equipment_type: str = Field(..., min_length=1, max_length=100, description="Type of equipment")
    ...
    maintenance_interval_days: Optional[int] = Field(None, ge=1, description="Days between preventive maintenance")
...
class MaintenanceRecordBase(BaseModel):
    ...
    description: str = Field(..., min_length=1, description="Description of maintenance work")
...
class EquipmentSearchParams(BaseModel):
    ...
    sort_by: str = Field(default="equipment_name", pattern="^(equipment_name|next_due_date|status|created_at)$")
...
class MaintenanceSearchParams(BaseModel):
    ...
    sort_by: str = Field(default="scheduled_date", pattern="^(scheduled_date|date_performed|status|cost)$")
