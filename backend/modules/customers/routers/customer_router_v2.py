...
async def create_customer(
    ...
    try:
        ...
        customer = service.create_customer(
            customer_data, restaurant_id=current_user.restaurant_id
        )
        ...
        return StandardResponse.error(
            message="Failed to create customer", code="DATABASE_ERROR"
        )
...
async def update_customer(
    ...
    try:
        ...
        return StandardResponse.error(
            message="Failed to update customer", code="DATABASE_ERROR"
        )
...
async def delete_customer(
    ...
    try:
        ...
        return StandardResponse.success(
            data=None, message="Customer deleted successfully"
        )

    except Exception as e:
        logger.error(f"Error deleting customer: {str(e)}")
        return StandardResponse.error(
            message="Failed to delete customer", code="DATABASE_ERROR"
        )
        ...
        try:
            ...
            if existing:
                results["failed"].append(
                    {"email": customer_data.email, "reason": "Duplicate email"}
                )
                continue
            ...
            results["failed"].append({"email": customer_data.email, "reason": str(e)})
