...
from backend.modules.settings.schemas.pos_sync_schemas import POSSyncSettingCreate, POSSyncSettingUpdate
from typing import List, Optional
from datetime import datetime

async def get_pos_sync_settings(db: Session, tenant_id: Optional[int] = None, team_id: Optional[int] = None) -> List[POSSyncSetting]:
...
async def create_or_update_pos_sync_setting(db: Session, setting_data: POSSyncSettingCreate) -> POSSyncSetting:
