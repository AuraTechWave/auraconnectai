...
from ..models.settings_models import (
    Setting, SettingDefinition, SettingGroup, ConfigurationTemplate,
    FeatureFlag, APIKey, Webhook, SettingHistory,
    SettingCategory, SettingType, SettingScope
)
from ..schemas.settings_schemas import (
    SettingCreate, SettingUpdate, SettingFilters,
    FeatureFlagCreate, FeatureFlagUpdate,
    APIKeyCreate, WebhookCreate, WebhookUpdate,
...
class SettingsService:
    ...
    def get_setting_value(
        ...
        if not setting:
            ...
            if scope == SettingScope.USER and location_id:
                setting = self.get_setting(key, SettingScope.LOCATION, restaurant_id, location_id)
        ...
        if definition and definition.default_value:
            return self._deserialize_value(definition.default_value, definition.value_type)
    ...
    def update_setting(
        ...
        """Update a setting"""
        setting = self._get_setting(key, scope, restaurant_id, location_id, setting_user_id)
