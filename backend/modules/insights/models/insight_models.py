...
from sqlalchemy import Column, Integer, String, Text, DateTime, ForeignKey, JSON, Boolean, Enum as SQLEnum, DECIMAL
...
class InsightAction(Base, TimestampMixin):
    ...
    action_type = Column(String(50), nullable=False)  # viewed, shared, exported, implemented
