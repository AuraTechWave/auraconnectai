...
def mask_sensitive_dict(data: Dict[str, Any], sensitive_keys: List[str] = None) -> Dict[str, Any]:
    """
    ...
    if sensitive_keys is None:
        sensitive_keys = [
            ...
            "private", "signature", "webhook_secret", "bearer_token",
            ...
            for key, value in obj.items():
                ...
                if any(sensitive in lower_key for sensitive in sensitive_keys):
                    if isinstance(value, str):
                        ...
                        obj[key] = {k: mask_sensitive_string(v) if isinstance(v, str) else v 
...
def mask_headers(headers: Dict[str, str], sensitive_headers: List[str] = None) -> Dict[str, str]:
    """
    ...
    if sensitive_headers is None:
        sensitive_headers = [
            ...
            "x-square-signature", "x-toast-api-key",
            "x-clover-api-key", "cookie", "set-cookie"
        ]
