...
def upgrade():
    ...
    op.add_column(
        "orders", sa.Column("tax_amount", sa.Numeric(10, 2), nullable=True, default=0.0)
    )
    ...
    op.add_column(
        "orders", sa.Column("referral_code_used", sa.String(50), nullable=True)
    )
    op.add_column(
        "orders",
        sa.Column("is_referral_qualifying", sa.Boolean, nullable=True, default=False),
    )
