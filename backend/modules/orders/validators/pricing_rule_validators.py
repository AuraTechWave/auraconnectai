...
TIME_CONDITIONS_SCHEMA = {
    ...
    "dependencies": {"start_time": ["end_time"], "end_time": ["start_time"]},
...
class PricingRuleValidator:
    ...
    def validate_conditions(
        self, conditions: Dict[str, Any], rule_type: str = None
    ...
    def _validate_business_logic(
        self, conditions: Dict[str, Any], warnings: List[str]
    ) -> List[str]:
        ...
        if "customer" in conditions:
            ...
            if (
                customer_cond.get("new_customer")
                and customer_cond.get("min_orders", 0) > 0
            ):
                errors.append("Cannot require both new_customer and min_orders > 0")
