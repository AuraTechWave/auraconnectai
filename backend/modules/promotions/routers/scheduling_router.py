...
def schedule_promotion(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to schedule promotion: {str(e)}"
        )
...
async def process_scheduled_promotions(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to process scheduled promotions: {str(e)}"
        )
...
def create_time_based_promotion(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to create time-based promotion: {str(e)}"
        )
...
async def process_time_based_promotions(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to process time-based promotions: {str(e)}"
        )
...
def create_promotion_sequence(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to create promotion sequence: {str(e)}"
        )
...
def get_scheduled_promotions(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get scheduled promotions: {str(e)}"
        )
...
def cancel_scheduled_promotion(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to cancel scheduled promotion: {str(e)}"
        )
...
def evaluate_time_based_rules(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to evaluate time-based rules: {str(e)}"
        )
...
def get_promotion_calendar(
    ...
    try:
        ...
        service = PromotionSchedulingService(db)
        scheduled_promotions = service.get_scheduled_promotions(
            start_date=start_date, end_date=end_date, include_recurring=True
        )
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get promotion calendar: {str(e)}"
        )
...
def preview_schedule(
    ...
    try:
        ...
        for _ in range(preview_count):
            next_occurrence = service._calculate_next_occurrence(
                current_date, schedule_options
            )
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to preview schedule: {str(e)}"
        )
