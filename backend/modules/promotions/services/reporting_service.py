...
class PromotionReportingService:
    ...
    def generate_executive_summary(
        ...
        try:
            ...
            performance_report = (
                self.analytics_service.generate_promotion_performance_report(
            ...
            insights = self._generate_insights(
                performance_report, coupon_report, referral_report
            )

            # Recommendations
            recommendations = self._generate_recommendations(
                performance_report, insights
            )
            ...
            return {
                ...
                "key_metrics": {
                    ...
                    "total_discounts_given": round(
                        performance_report["summary"]["total_discounts_given"], 2
                    ),
                    "overall_roi": round(
                        performance_report["summary"]["overall_roi_percentage"], 2
                    ),
                    "customer_engagement": performance_report["customer_engagement"][
                        "total_customers_engaged"
                    ],
                },
                "performance_highlights": {
                    "top_promotion": (
                        performance_report["top_performing_promotions"][0]
                        if performance_report["top_performing_promotions"]
                        else None
                    ),
                    "most_popular_promotion_type": self._get_most_popular_type(
                        performance_report["promotion_type_analysis"]
                    ),
                    "coupon_usage_rate": self._calculate_coupon_usage_rate(
                        coupon_report
                    ),
                    "referral_success_rate": referral_report["summary"][
                        "completion_rate_percentage"
                    ],
                },
                "channel_performance": {
                    "promotions": {
                        "active_count": performance_report["summary"][
                            "active_promotions"
                        ],
                        "total_usage": sum(
                            p["usage_metrics"]["total_usage"]
                            for p in performance_report["promotion_details"]
                        ),
                        "avg_roi": performance_report["summary"][
                            "overall_roi_percentage"
                        ],
                    },
                    "coupons": {
                        "total_used": coupon_report["summary"]["total_coupons_used"],
                        "unique_customers": coupon_report["summary"][
                            "unique_customers"
                        ],
                        "total_discount": coupon_report["summary"][
                            "total_discount_given"
                        ],
                    },
                    "referrals": {
                        "total_referrals": referral_report["summary"][
                            "total_referrals"
                        ],
                        "completion_rate": referral_report["summary"][
                            "completion_rate_percentage"
                        ],
                        "total_rewards": referral_report["summary"][
    ...
    def _generate_insights(
        self, performance_report: Dict, coupon_report: Dict, referral_report: Dict
    ) -> List[Dict[str, Any]]:
    ...
    def _generate_recommendations(
        self, performance_report: Dict, insights: List[Dict]
    ) -> List[Dict[str, Any]]:
    ...
    def _calculate_coupon_usage_rate(self, coupon_report: Dict) -> float:
        ...
        return round(
            coupon_report["summary"]["total_coupons_used"]
            / max(coupon_report["summary"]["unique_customers"], 1),
            2,
        )

    def export_report_csv(
        self, report_data: Dict[str, Any], report_type: str = "performance"
    ) -> str:
        """
        ...
        try:
            ...
            if report_type == "performance":
                ...
                writer.writerow(
                    ["Coupon Code", "Type", "Usage Count", "Total Discount"]
                )
    ...
    def generate_scheduled_report(
        ...
        try:
            ...
            logger.info(
                f"Generated scheduled {report_type} report for {frequency} frequency"
            )
    ...
    def generate_comparison_report(
        ...
        try:
            ...
            for metric in [
                ...
                percentage_change = (
                    (change / period2_value * 100) if period2_value != 0 else 0
                )
