...
class HuggingFaceProvider(ModelProviderInterface):
    ...
    def __init__(self, config: ModelProviderConfig):
        ...
        self.api_base = (
            config.api_base_url or "https://api-inference.huggingface.co/models"
        )
    ...
    async def generate(
        ...
        if "gpt" in model_name.lower() or "bloom" in model_name.lower():
            ...
            # Generic payload
            payload = {"inputs": request.prompt, "parameters": request.provider_params}
        ...
        if isinstance(response_data, list) and len(response_data) > 0:
            ...
            text = response_data.get(
                "generated_text", response_data.get("translation_text", "")
            )
        else:
        ...
        return ModelResponse(
            ...
            provider_metadata={"raw_response": response_data},
