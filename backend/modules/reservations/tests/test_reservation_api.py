...
class TestReservationAPI:
    ...
    def setup_tables(self, db_session: Session):
        ...
        tables = [
            ...
            TableConfiguration(
                table_number="2", section="main", min_capacity=4, max_capacity=6
            ),
        ]
        for table in tables:
    ...
    def test_create_reservation_success(
        ...
        response = client.post(
            "/api/v1/reservations", json=reservation_data, headers=customer_headers
        )
    ...
    def test_get_my_reservations(
        ...
        response = client.get(
            "/api/v1/reservations/my-reservations", headers=customer_headers
        )
    ...
    def test_check_availability(self, client: TestClient, setup_tables):
    ...
    def test_get_reservation_by_id(
        ...
        response = client.get(
            f"/api/v1/reservations/{reservation.id}", headers=customer_headers
        )
    ...
    def test_update_reservation(
        ...
        update_data = {"party_size": 4, "special_requests": "Need high chair"}
    ...
    def test_cancel_reservation(
        ...
        cancel_data = {"reason": "Changed plans", "cancelled_by": "customer"}
