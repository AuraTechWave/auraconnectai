...
from sqlalchemy import Column, Integer, String, ForeignKey, Numeric, Boolean, Text, DateTime, Enum as SQLEnum
...
class RefundRequest(Base, TimestampMixin):
    ...
    # Approval workflow
    approval_status = Column(SQLEnum(RefundApprovalStatus), default=RefundApprovalStatus.PENDING_APPROVAL)
...
class RefundAuditLog(Base, TimestampMixin):
    ...
    # Action details
    action = Column(String(50), nullable=False)  # created, approved, rejected, processed, failed
