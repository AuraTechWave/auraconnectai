...
refund_completed_total = Counter(
    ...
    'Total number of refunds completed',
    ['gateway']
)
...
fee_amount_total = Counter(
    'fee_amount_total',
    'Total processing fees in cents',
    ['gateway', 'currency']
)
...
active_payment_actions = Gauge(
    'active_payment_actions',
    'Number of payments requiring action',
    ['gateway']
)
...
payment_gateway_info = Info(
    ...
    'Payment gateway configuration info'
)
...
class PaymentMetrics:
    ...
    @staticmethod
    def record_payment_action_required(
        gateway: PaymentGateway,
        action_type: str
    ):
    ...
    def update_gateway_availability(gateway: PaymentGateway, available: bool):
        ...
        payment_gateway_available.labels(
            gateway=gateway.value
