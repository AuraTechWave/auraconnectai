...
class TestPaymentIntegration:
    ...
    async def test_complete_payment_flow(
        self, async_session: AsyncSession, setup_test_data
    ):
    ...
    async def test_multi_gateway_payments(
        ...
        gateways = [PaymentGateway.STRIPE, PaymentGateway.SQUARE, PaymentGateway.PAYPAL]
    ...
    async def test_webhook_race_condition(
        ...
        webhook_body = (
            b'{"id": "evt_duplicate_test", "type": "payment_intent.succeeded"}'
        )
