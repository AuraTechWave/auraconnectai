    ...
    async def create_payment(self, request: PaymentRequest) -> PaymentResponse:
        ...
        try:
            ...
            if request.statement_descriptor:
                params['statement_descriptor'] = request.statement_descriptor[:22]  # Stripe limit
            ...
            return PaymentResponse(
                ...
                processed_at=datetime.fromtimestamp(intent.created) if intent.created else None,
    ...
    async def list_payment_methods(self, customer_id: str) -> List[PaymentMethodResponse]:
        ...
        try:
            payment_methods = stripe.PaymentMethod.list(
                ...
                type='card'  # Can be expanded to other types
            )
