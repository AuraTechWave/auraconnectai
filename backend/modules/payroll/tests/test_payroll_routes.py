...
class TestTaxCalculationRoutes:
    ...
    @patch(
        "backend.modules.payroll.routes.tax_calculation_routes.require_payroll_access"
    )
    ...
    def test_get_tax_rules_success(self, mock_auth):
        ...
        # Mock database query
        with patch(
            "backend.modules.payroll.routes.tax_calculation_routes.Session"
        ) as mock_session:
            mock_db = Mock()
            mock_query = Mock()
    ...
    def test_get_effective_tax_rates(self, mock_auth):
        ...
        with patch(
            "backend.modules.payroll.routes.tax_calculation_routes.PayrollTaxEngine"
        ) as mock_engine:
            mock_engine_instance = Mock()
...
class TestConfigurationRoutes:
    ...
    def test_get_payroll_configurations(self, mock_auth):
        ...
        with patch(
            "backend.modules.payroll.routes.configuration_routes.PayrollConfigurationService"
        ) as mock_service:
    ...
    def test_create_staff_pay_policy(self, mock_auth):
        ...
        with patch(
            "backend.modules.payroll.routes.configuration_routes.get_db",
    ...
    def test_update_staff_pay_policy(self, mock_auth):
        ...
        with patch(
            ...
            response = client.put(
                ...
                json={"base_hourly_rate": "25.00", "health_insurance": "200.00"},
                headers={"Authorization": "Bearer test_token"},
            )
...
class TestPaymentRoutes:
    ...
    def test_get_employee_payment_history(self, mock_auth):
        ...
        with patch(
            "backend.modules.payroll.routes.payment_routes.get_db", return_value=mock_db
        ):
            response = client.get(
