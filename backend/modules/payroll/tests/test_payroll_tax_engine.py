...
class TestPayrollTaxEngine:
    ...
    def test_calculate_payroll_taxes_with_multiple_rules(
        ...
        assert all(
            app.calculated_tax > Decimal("0.00") for app in result.tax_applications
        )
    ...
    def test_get_applicable_tax_rules_filters_by_date(self, tax_engine, mock_db):
        ...
        mock_query.all.return_value = [
            current_rule
        ]  # Only current rule should be returned
        mock_db.query.return_value = mock_query
    ...
    def test_apply_tax_rule_with_max_taxable_amount(self, tax_engine, sample_request):
    ...
    def test_apply_tax_rule_with_min_taxable_amount(self, tax_engine, sample_request):
    ...
    def test_save_tax_applications(self, tax_engine, mock_db):
        ...
        saved_apps = tax_engine.save_tax_applications(
            employee_payment_id=123, tax_applications=applications
        )
