...
from ..enums.payroll_enums import (
    TaxRuleType, TaxRuleStatus, PaymentStatus,
    PayrollJobStatus
)
...
class OvertimeRuleCreate(BaseModel):
    ...
    daily_double_time_threshold: Optional[Decimal] = Field(default=Decimal('12.0'), gt=0)
    weekly_double_time_threshold: Optional[Decimal] = Field(default=Decimal('60.0'), gt=0)
