...
async def get_employee_payment_history(
    ...
    try:
        ...
        payments = (
            query.order_by(EmployeePayment.pay_period_end.desc())
            .limit(limit)
            .offset(offset)
            .all()
        )
        ...
        return PaymentHistoryResponse(
            ...
            summary={
                ...
                "total_deductions": str(
                    (stats.total_gross or 0) - (stats.total_net or 0)
                ),
...
async def get_payment_details(
    ...
    try:
        ...
        tax_applications = (
            db.query(EmployeePaymentTaxApplication)
            .filter(EmployeePaymentTaxApplication.employee_payment_id == payment_id)
            .all()
        )
        ...
        return PaymentDetailResponse(
            ...
            hours={
                ...
                "total": str(
                    ...
                    + payment.double_time_hours
                    + payment.holiday_hours
                    + payment.sick_hours
                    + payment.vacation_hours
                ),
            },
            earnings={
            ...
            deductions={
                "taxes": {
                    ...
                    "total": str(
                        payment.federal_tax_amount
                        + payment.state_tax_amount
                        + payment.local_tax_amount
                        + payment.social_security_amount
                        + payment.medicare_amount
                        + payment.unemployment_amount
                    ),
                },
                "benefits": {
                    ...
                    "total": str(
                        payment.health_insurance_amount
                        + payment.dental_insurance_amount
                        + payment.vision_insurance_amount
                        + payment.retirement_401k_amount
                        + payment.life_insurance_amount
                        + payment.disability_insurance_amount
