...
class PaymentExportService:
    ...
    async def export_payments(
        ...
        payments = query.order_by(
            ...
            EmployeePayment.pay_period_start
        ).all()
    ...
    def _export_to_csv(self, payments: List[EmployeePayment], include_details: bool) -> Dict[str, Any]:
        ...
        if include_details:
            fieldnames = [
                ...
                'gross_amount', 'federal_tax', 'state_tax', 'social_security',
                'medicare', 'net_amount', 'status', 'paid_at'
            ]
        else:
            fieldnames = [
                'employee_id', 'pay_period_start', 'pay_period_end',
    ...
    def _export_to_excel(self, payments: List[EmployeePayment], include_details: bool) -> Dict[str, Any]:
    ...
    def _export_to_pdf(self, payments: List[EmployeePayment], include_details: bool) -> Dict[str, Any]:
