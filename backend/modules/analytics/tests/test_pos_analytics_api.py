...
class TestPOSAnalyticsDashboard:
    ...
    def test_get_dashboard_default(
        ...
        mock_pos_provider, mock_terminal_health, mock_analytics_snapshots
    ):
    ...
    def test_get_dashboard_custom_range(
        self, client: TestClient, db: Session, auth_headers,
        mock_pos_provider, mock_analytics_snapshots
    ):
...
class TestPOSAlerts:
    ...
    def test_get_active_alerts(
        self, client: TestClient, db: Session, auth_headers,
        mock_pos_provider, mock_pos_alert
    ):
    ...
    def test_acknowledge_alert(
        self, client: TestClient, db: Session, auth_headers,
        mock_pos_provider, mock_pos_alert, mock_staff_user
    ):
...
class TestPOSHealthSummary:
    ...
    def test_get_terminal_health(
        self, client: TestClient, db: Session, auth_headers,
        mock_pos_provider, mock_terminal_health
    ):
...
class TestPOSExport:
    ...
    @patch('backend.modules.analytics.services.pos_analytics_service.POSAnalyticsService.export_analytics')
    async def test_export_analytics(
        self, mock_export, client: TestClient, db: Session, auth_headers,
        mock_pos_provider
    ):
