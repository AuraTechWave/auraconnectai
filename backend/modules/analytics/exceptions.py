...
class ExternalServiceError(AnalyticsBaseException):
    ...
    def __init__(
        self, service_name: str, reason: str, retry_after: Optional[int] = None
    ):
...
class RateLimitError(AnalyticsBaseException):
    ...
    def __init__(self, endpoint: str, limit: int, window: str, retry_after: int):
...
class PermissionError(AnalyticsBaseException):
    ...
    def __init__(
        self, required_permission: str, user_id: int, resource: Optional[str] = None
    ):
