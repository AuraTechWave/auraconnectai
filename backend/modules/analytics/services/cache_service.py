...
class HistoricalDataCache(CacheService):
    ...
    def get_historical_data(
        self, entity_type: str, entity_id: Optional[int], granularity: str
    ) -> Optional[Any]:
...
class ModelCache(CacheService):
    ...
    def get_model(
        self, entity_type: str, entity_id: Optional[int], model_type: str
    ) -> Optional[Any]:
    ...
    def invalidate_models(
        self, entity_type: Optional[str] = None, entity_id: Optional[int] = None
    ) -> int:
