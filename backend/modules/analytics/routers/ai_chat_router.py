...
from ..schemas.ai_assistant_schemas import (
    ChatRequest, ChatResponse, ChatMessage, WebSocketMessage,
    SuggestedQuery, AssistantCapabilities, FeedbackRequest,
    ConversationSummary, MessageRole, MessageType
)
...
async def chat_websocket_endpoint(
    ...
    try:
        ...
        # Check permissions
        if not any(perm in user_info.get("permissions", []) for perm in [
                    ...
                    if message_data.get("type") == "chat":
                        ...
                        response_msg = WebSocketMessage(
                            ...
                            data={
                                ...
                                "query_result": response.query_result.dict() if response.query_result else None,
...
def _get_assistant_capabilities() -> dict:
    ...
    return {
        ...
        "supported_metrics": [
            ...
            "growth", "efficiency", "popularity"
        ],
        "supported_time_ranges": [
            "today", "yesterday", "this week", "last week",
            "this month", "last month", "custom date ranges"
        ],
        ...
        "available_data_sources": [
            "sales", "orders", "products", "staff", "customers"
        ]
    }
