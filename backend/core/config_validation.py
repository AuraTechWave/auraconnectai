...
class EnvironmentConfig(BaseSettings):
    ...
    def validate_secrets(cls, v, info):
        ...
        if env == "production" and "dev-secret" in v:
            raise ValueError(f"{field_name} must be changed from default value in production")
    ...
    def validate_for_production(self):
        ...
        if self.ALLOW_INSECURE_HTTP:
            errors.append("HTTPS is required for production (set ALLOW_INSECURE_HTTP=false)")
