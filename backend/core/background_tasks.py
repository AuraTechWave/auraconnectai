...
class TaskManager:
    ...
    def schedule_analytics_calculation(
        self, analytics_type: str, date_range: Dict[str, Any] = None
    ):
    ...
    def get_task_status(self, task_id: str) -> Dict[str, Any]:
        ...
        if task_id in self.task_history:
            ...
            return {
                ...
                "progress": (
                    celery_task.info if celery_task.status == "PROGRESS" else None
                ),
            }
...
@celery_app.task(
    bind=True, name="backend.core.background_tasks.calculate_daily_analytics"
)
def calculate_daily_analytics(self):
    ...
    try:
        ...
        self.update_state(
            state="PROGRESS",
            meta={"current": 0, "total": 4, "status": "Starting daily analytics"},
        )
        ...
        try:
            ...
            self.update_state(
                ...
                meta={
                    "current": 1,
                    "total": 4,
                    "status": "Calculating loyalty analytics",
                },
            )
            from modules.loyalty.services.analytics_service import (
            ...
            self.update_state(
                ...
                meta={
                    "current": 2,
                    "total": 4,
                    "status": "Calculating customer analytics",
                },
            )
            from modules.customers.services.analytics_service import (
            ...
            self.update_state(
                ...
                meta={
                    "current": 3,
                    "total": 4,
                    "status": "Calculating revenue analytics",
                },
            )
            ...
            self.update_state(
                state="PROGRESS",
                meta={"current": 4, "total": 4, "status": "Finalizing analytics"},
            )
...
@celery_app.task(
    bind=True, name="backend.core.background_tasks.calculate_weekly_analytics"
)
def calculate_weekly_analytics(self):
    ...
    try:
        self.update_state(
            state="PROGRESS",
            meta={"current": 0, "total": 3, "status": "Starting weekly analytics"},
        )
...
@celery_app.task(
    bind=True, name="backend.core.background_tasks.calculate_monthly_analytics"
)
def calculate_monthly_analytics(self):
    ...
    try:
        self.update_state(
            state="PROGRESS",
            meta={"current": 0, "total": 3, "status": "Starting monthly analytics"},
        )
...
@celery_app.task(
    bind=True, name="backend.core.background_tasks.calculate_custom_analytics"
)
