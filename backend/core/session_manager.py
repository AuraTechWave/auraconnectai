...
class SessionManager:
    ...
    def get_session(self, session_id: str) -> Optional[Session]:
        ...
        try:
            if self.redis:
                ...
                self.redis.hset(session_key, "last_accessed", session.last_accessed.isoformat())
    ...
    def revoke_all_user_sessions(self, user_id: int) -> int:
        ...
        try:
            ...
            if self.redis:
                ...
                # Memory storage
                sessions_to_revoke = [
                    sid for sid, session in self._memory_sessions.items()
    ...
    def blacklist_token(self, token: str, expires_at: Optional[datetime] = None) -> bool:
        """
